...
namespace TMS.Data.Implementations
{
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public virtual IQueryable<T> GetAllAsQueryable(Func<IQueryable<T>, IOrderedQueryable<T>> orderBy = null, Func<IQueryable<T>, IIncludableQueryable<T, object>> include = null)
        {
            try
            {
                IQueryable<T> query = ConstructQuery(orderBy, include);
